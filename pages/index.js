  ...
  return (
    <div className={styles.container}>
      <form onSubmit={handleSubmit}>
        ...
        <TextField id="dias_vacaciones" type="number" label="Cant. Dias Vacaciones" variant="filled" onChange={handleDiasVacaciones} name="dias_vacaciones" />
        <br />
        <Button variant="contained" type="submit" color="primary" >Calcular</Button>
        <br />
      </form>
      <div>
        <p>Dias de vacaciones: {dias}</p>
        <p>Fecha final de vacaciones: {fechaFinal}</p>
